...
if ($_POST){
	...
	$sql_agregar = 'INSERT INTO mascotas (nombre,raza) VALUES (?,?)';
	$sentencia_agregar = $pdo->prepare($sql_agregar);
	$sentencia_agregar->execute(array($nombre,$raza));

	header('location:mascotasIndex.php');
}
if ($_GET) {
	$id = $_GET['id'];
	$sql_unico = 'SELECT * FROM `mascotas` WHERE id=?';
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="index.php">usuarios <span 
    ...
    <div class="row">
      ...
      <?php foreach($resultado as $dato): ?>
        ...
        <div 
            ...
            <a href="mascotasEliminar.php?id=<?php echo $dato['id'] ?>" class="float-right ml-3">
      ...
      <div class="col-md-6">
        <?php if(!$_GET):?>
          ...
          <form method="POST">
           ...
           <input placeholder="raza"type="text" class="form-control mt-3"
            name="raza" required>
